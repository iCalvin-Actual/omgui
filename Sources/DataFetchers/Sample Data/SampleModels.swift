...
extension NowModel {
    static func random(from address: AddressName) -> NowModel {
        .init(
            owner: address,
            content: lorum,
            updated: Date(),
...
Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. [Excepteur](https://app.omg.lol) sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
"""
    }
}
